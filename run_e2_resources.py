...
def _clean_code_commit() -> str:
    ...
    if status.strip():
        raise RuntimeError(
            "Formal E2 must run from the clean committed Step 4 implementation"
        )
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run formal Step 4 / E2 logical and compiled resources"
    )
    ...
    summary = run_e2_resources_pipeline(
