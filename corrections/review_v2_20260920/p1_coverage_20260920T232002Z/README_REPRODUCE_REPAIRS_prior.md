...
第一条预先选择两个 family、三个 topology、两种 synthesis、三类候选的代表，按最小逻辑宽度、instance ID、candidate ID 排序选择，执行 108 条重放；第二、三条实际运行新 P0→P1，再执行独立的 108 条有限预检。均不启动 101,460 次全量编译。
