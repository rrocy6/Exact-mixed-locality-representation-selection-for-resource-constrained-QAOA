...
```powershell
& .\revisions\URSS_20260917_verified_v1\.venv_revision\Scripts\python.exe -X utf8 -B scripts\multiseed_experiment.py --stage all --run-dir C:/Users/rocyz/Desktop/量子算法组合优化tsp/协作/URSS_REPAIR_20260920_154042_4937f93c/URSS_REPAIR_WORKSPACE_20260920/project/corrections/review_v2_20260920/analysis
```
Resume formal batches with `--stage run --run-dir C:/Users/rocyz/Desktop/量子算法组合优化tsp/协作/URSS_REPAIR_20260920_154042_4937f93c/URSS_REPAIR_WORKSPACE_20260920/project/corrections/review_v2_20260920/analysis`; re-run analysis only with `--stage analyze`.
